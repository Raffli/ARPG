...
////// Specular:
                ...
                float3 indirectSpecular = (0 + (lerp(lerp((0.7*node_215),node_215,node_223),_Specular_var.rgb,node_223)*((i.normalDir.g*node_11)+(1.0 - node_11))));
